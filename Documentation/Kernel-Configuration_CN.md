...
Droidspaces 需要特定的内核选项来运行隔离的容器。这些选项启用 Linux 命名空间、cgroups、seccomp 过滤、网络以及设备文件系统支持。
...
启动后，打开 Droidspaces 应用，前往 **设置**（齿轮图标）-> **需求检查** -> **检查需求** 来验证您的配置。
